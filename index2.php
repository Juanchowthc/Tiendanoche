...
$consultadisp= "SELECT ID_RELOJ, NOMBRE, DESCRIPCION, PRECIO, DESCUENTO, IMAGEN FROM RELOJES where disponibilidad>=1";
...
<html lang="en" data-bs-theme="light"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script src="./index2_files/color-modes.js.descarga"></script>
...
<header data-bs-theme="dark">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="index2.html" class="navbar-brand d-flex align-items-center">
        <svg xmlns="" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" aria-hidden="true" class="me-2" viewBox="0 0 24 24"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
        <strong>Productos</strong>
      </a>
      <div id="button-container">
  <a href="login.php"><button class="active">INICIA SESION</button></a>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="<?php echo $row['IMAGEN']; ?>" class="bd-placeholder-img card-img-top" width="100%" height="225">
            <div class="card-body">
